      ...
      <div className="px-8 py-12 bg-gray-50 mt-8 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 relative">
          ...
          <div>
            <Link 
              to="/Explorer" 
              className="absolute -right-10 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-400/50 rounded-3xl shadow-2xl p-4 z-50 hover:bg-amber-500/60"
            >
              <IoArrowForwardOutline className='text-white text-2xl'/>
            </Link>        
          </div>
        </div>
      </div>
